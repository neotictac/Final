...
var App = React.createClass({
  ...
  viewChanged: function(view) {
    ...
    if (view.currentView === 'latest') {
      return (
        this.setState({
//          movies: movieData.sort(this.movieComparedByReleased),
          currentView: movieData.sort(this.movieComparedByTitle)
        })
      )
    }
    if (view.currentView === 'alpha') {
      return (
        this.setState({
//          movies: movieData.sort(this.movieComparedByTitle),
          currentView: movieData.sort(this.movieComparedByTitle)
        })
      )
    } else {
